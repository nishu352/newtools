  ...
  return (
    <div className="flex flex-col gap-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div>
            ...
            <input
              ...
              placeholder="80.00"
              className="w-full px-3.5 py-2.5 text-sm rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-100 font-semibold focus:outline-none focus:ring-2 focus:ring-[var(--primary)]"
            />
          </div>
          ...
          {[10, 15, 20, 25, 30, 40, 50, 70].map((pct) => (
            <button
              ...
              className={`px-2.5 py-1 text-xs rounded-md border transition-colors cursor-pointer ${
                discount === String(pct)
                  ? 'bg-slate-900 text-white dark:bg-[var(--primary)] border-transparent'
      ...
      {res.error ? (
        ...
        /* Results Breakdown */
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="p-5 rounded-xl border border-[var(--primary)]/30/30 bg-[var(--primary)]/5 flex flex-col justify-between">
            <div>
          ...
          <div className="p-5 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/40 flex flex-col justify-between">
            <div>
              ...
              <span className="text-2xl font-bold text-[var(--primary)] dark:text-[var(--primary)]">
