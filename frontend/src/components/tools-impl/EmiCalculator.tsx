  ...
  return (
    <div className="space-y-6">
      ...
      {result && result.interestSaved && result.interestSaved > 0 && (
        <div className="p-4 rounded-2xl bg-[var(--primary)]/10 border border-[var(--primary)]/30/20 flex items-center justify-between gap-4 text-emerald-800 dark:text-emerald-200">
      ...
      {result && (
        <div className="p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm space-y-4">
          ...
          <div className="h-6 w-full rounded-xl overflow-hidden flex bg-slate-100 dark:bg-slate-800">
            <div
              className="bg-[var(--primary)] transition-all duration-500 flex items-center justify-center text-[10px] font-bold text-white"
          ...
          <div className="flex justify-between items-center text-xs font-medium text-slate-600 dark:text-slate-400">
            <div className="flex items-center gap-2">
              <span className="w-3 h-3 rounded-full bg-[var(--primary)] shrink-0" />
              <span>
                  ...
                  <tbody className="divide-y divide-slate-100 dark:divide-slate-800/60 font-mono">
                    {paginatedSchedule.map((row) => (
                      <tr key={row.month} className="hover:bg-slate-50 dark:hover:bg-slate-800/40">
                        ...
                        <td className="py-2 px-3 text-[var(--primary)] dark:text-[var(--primary)] font-semibold">
