...
export const CATEGORIES: Record<ToolCategory, CategoryDefinition> = {
  ...
  data: {
    ...
    description: 'JSON diff, flattening, key sorting, CSV transposition, and Data URI utilities.',
    intro: 'Transform, format, inspect, and analyze JSON, CSV, TSV, and structural data completely client-side.',
    icon: 'Database',
    displayOrder: 14,
    relatedCategories: ['developer', 'excel'],
  },
  security: {
    slug: 'security',
    name: 'Encoding & Security',
    description: 'Multi-hash generators, HMAC, Hex/Binary converters, and obfuscation ciphers.',
    intro: 'Cryptographic hashing, keyed HMAC, encoding conversions, and secure token generation right in your browser.',
    icon: 'ShieldCheck',
    displayOrder: 15,
    relatedCategories: ['developer', 'everyday-utilities'],
  },
  'date-time': {
    slug: 'date-time',
    name: 'Date & Time Tools',
    description: 'Unix timestamps, date differences, business days, and world timezone converters.',
    intro: 'Calculate date spans, working days, Unix epoch conversions, and timezone offsets without complex setups.',
    icon: 'Clock',
    displayOrder: 16,
    relatedCategories: ['productivity', 'developer'],
  },
  generators: {
    slug: 'generators',
    name: 'Generators',
    description: 'Secure random strings, NanoID, numbers, passwords, and placeholder text generators.',
    intro: 'Generate cryptographic identifiers, random data, numbers, and dummy text with custom configurations.',
    icon: 'Sparkles',
    displayOrder: 17,
    relatedCategories: ['developer', 'security'],
  },
  'qr-barcode': {
    slug: 'qr-barcode',
    name: 'QR & Barcode',
    description: 'Create and decode QR codes from text, URLs, vCards, Wi-Fi, and images.',
    intro: 'Generate and scan QR codes directly in your browser with zero server uploads or external tracking.',
    icon: 'QrCode',
    displayOrder: 18,
    relatedCategories: ['everyday-utilities', 'web-seo'],
  },
  'css-design': {
    slug: 'css-design',
    name: 'CSS & Design Tools',
    description: 'CSS gradients, box shadows, unit converters (PX, REM, EM), and color tools.',
    intro: 'Interactive visual designers for CSS gradients, shadows, units, and palettes with instant copyable code.',
    icon: 'Palette',
    displayOrder: 19,
    relatedCategories: ['image', 'developer'],
  },
  productivity: {
    slug: 'productivity',
    name: 'Productivity Tools',
    description: 'Pomodoro timer, stopwatch, random choice pickers, and decision makers.',
    intro: 'Streamline your daily workflow with focus timers, random choice pickers, and quick productivity helpers.',
    icon: 'CheckSquare',
    displayOrder: 20,
    relatedCategories: ['date-time', 'everyday-utilities'],
  },
};
